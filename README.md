# GenOffice (VuaOffice Distribution)

> **Lưu ý quan trọng cho nhà phát triển VuaOffice / 360 CORP:**  
> Dự án này đã được cấu hình cơ chế **Whitelabel** tự động để chuyển đổi thành **VuaOffice**.  
> - Để xem tài liệu hướng dẫn triển khai và các tập lệnh whitelabel, hãy đọc [DEPLOY_GUIDE.md](DEPLOY_GUIDE.md).
> - Để xem kiến trúc whitelabel, đọc [ARCH.md](ARCH.md).
> - Để xem lịch sử phát triển whitelabel, đọc [CHANGELOGS.md](CHANGELOGS.md).
