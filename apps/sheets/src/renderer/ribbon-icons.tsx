...
/** VuaOffice AI brand mark (rounded-square badge with V crown), inline so it renders
...
export function GensparkMark({ size = 18 }: { readonly size?: number }): ReactElement {
  return (
    <svg
      ...
      aria-hidden
    >
      <rect width="100" height="100" rx="22" fill="#2367EC" />
      <path
        d="M28 32L50 72L72 32"
        stroke="white"
        strokeWidth="12"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <circle cx="50" cy="26" r="6" fill="#00D2FF" />
    </svg>
  )
}
