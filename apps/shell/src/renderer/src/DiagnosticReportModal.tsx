...
const LOCAL_STRINGS: Record<string, Record<string, string>> = {
  vi: {
    ...
    sendToVuaOffice: 'Gửi tới VuaOffice (GitLab Issues)',
    sending: 'Đang gửi báo cáo...',
    sendSuccess: 'Đã gửi báo cáo thành công lên GitLab Issues!',
    viewIssue: 'Xem Issue trên GitLab',
    sendError: 'Không thể gửi trực tiếp, bạn có thể xuất file hoặc mở GitLab tạo Issue thủ công.',
    close: 'Đóng',
  ...
  en: {
    ...
    sendSuccess: 'Diagnostic report successfully submitted to GitLab Issues!',
    viewIssue: 'Open Issue on GitLab',
    sendError: 'Could not submit directly. You can export to a file or open GitLab manually.',
    close: 'Close',
  ...
  zh: {
    ...
    offline: '异常',
    exportFile: '导出为文件',
    sendToVuaOffice: '发送到 VuaOffice (GitLab)',
    sending: '正在提交报告...',
    sendSuccess: '报告已成功提交至 GitLab Issues！',
    viewIssue: '查看 GitLab Issue',
    sendError: '提交失败，您可以导出为本地文件或手动在 GitLab 提交。',
    close: '关闭',
