...
export const strings = {
  zh: {
    ...
    onbStarHint: '如果你喜欢 VuaOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
  ...
  en: {
    ...
    onbStarHint: 'If you like VuaOffice, give us a star on GitHub.',
    setEmail: 'Email',
  ...
  ja: {
    ...
    starPromptLater: 'あとで',
    onbStarHint: 'VuaOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptLater: '나중에',
    onbStarHint: 'VuaOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    onbStarHint: 'Si VuaOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
  ...
  de: {
    ...
    onbStarHint: 'Wenn Ihnen VuaOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
  ...
  es: {
    ...
    onbStarHint: 'Si te gusta VuaOffice, danos una estrella en GitHub.',
  ...
  th: {
    ...
    onbStarHint: 'ถ้าชอบ VuaOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
  ...
  id: {
    ...
    onbStarHint: 'Jika Anda menyukai VuaOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
  ...
  ru: {
    ...
    onbStarHint: 'Если вам нравится VuaOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
  ...
  ar: {
    ...
    onbStarHint: 'إذا أعجبك VuaOffice، ضع لنا نجمة على GitHub.',
  ...
  pt: {
    ...
    onbStarHint: 'Se você gosta do VuaOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
  ...
  it: {
    ...
    onbStarHint: 'Se ti piace VuaOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
  ...
  pl: {
    ...
    onbStarHint: 'Jeśli podoba Ci się VuaOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
  ...
  nl: {
    ...
    onbStarHint: 'Als VuaOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
  ...
  ms: {
    ...
    onbStarHint: 'Jika anda suka VuaOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
  ...
  he: {
    ...
    onbStarHint: 'אם VuaOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
  ...
  hi: {
    ...
    onbStarHint: 'अगर आपको VuaOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
  ...
  'zh-TW': {
    ...
    onbStarHint: '如果你喜歡 VuaOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
